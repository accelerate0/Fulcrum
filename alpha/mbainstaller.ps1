...
$installpath = "$PSScriptRoot\utilities\mbainstaller"
...
$link = "https://www.malwarebytes.com/mwb-download/thankyou/"
$destination = "$installpath\mba.exe"
...
Start-Process -FilePath "$installpath\mba.exe" -ArgumentList "/S"
